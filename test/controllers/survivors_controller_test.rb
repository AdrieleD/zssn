...
class SurvivorsControllerTest < ActionController::TestCase
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post :create, survivor: { age: @survivor.age, gender: @survivor.gender, lastLatitude: @survivor.lastLatitude, lastLongitude: @survivor.lastLongitude, name: @survivor.name }
    end
  ...
  test "should update survivor" do
    patch :update, id: @survivor, survivor: { age: @survivor.age, gender: @survivor.gender, lastLatitude: @survivor.lastLatitude, lastLongitude: @survivor.lastLongitude, name: @survivor.name }
    assert_redirected_to survivor_path(assigns(:survivor))
  end
